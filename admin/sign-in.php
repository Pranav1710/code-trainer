...
<head>
  ...
  <body class="bg-light-gray" id="body">
              ...
              <form action="checkpass.php" method="POST">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <button type="submit" class="btn btn-lg btn-primary btn-block mb-4" style="margin-left: 5em";>Sign In</button>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2020 All Copyright Reserved By Code Trainer</p>
      </div>
    </div>
</body>
</html>